...
// allowance. Set ODDS_API_KEY in the Vercel project settings and rotate the old
// key, because the exposed one should be treated as compromised.
//
// Deploy: drop this file at api/odds.js in the repo root.
